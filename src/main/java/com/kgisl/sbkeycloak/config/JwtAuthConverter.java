...
public class JwtAuthConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private Collection<? extends GrantedAuthority> extractRoles(Jwt jwt) {
        ...
        if (resourceAccess != null && resourceAccess.containsKey("Keycloak_springboot")) {
            Map<String, Object> demoAccess = (Map<String, Object>) resourceAccess.get("Keycloak_springboot");
